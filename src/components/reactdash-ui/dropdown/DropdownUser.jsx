...
export default function DropdownUser(props) {
  ...
  const [_, remove] = useLocalStorage("token");
  ...
  return (
    <Menu>
      ...
      >
        ...
        <span className="h-10 w-full flex items-center justify-center  ltr:ml-1 rtl:mr-1 self-center font-bold">
          {props.user?.fullname || "Loading data..."}
        </span>
      </Menu.Button>
      <Transition
            ...
            <div className="flex flex-wrap flex-row -mx-4 px-3 py-4 items-center">
              ...
              <div className="flex-shrink max-w-full px-4 w-2/3 ltr:pl-1 rtl:pr-1">
                <div className="font-bold">
                  ...
                  >
                    {props.user?.fullname || "Loading.."}
                  </Link>
                </div>
                <div className="text-gray text-sm mt-1">{props.user?.role}</div>
              </div>
            </div>
          </li>
          <li className="relative">
