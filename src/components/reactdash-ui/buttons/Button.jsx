...
export default function Button(props) {
  ...
  const colors = {
    ...
    gold: "text-white bg-primary-color capitalize disabled:cursor-not-allowed disabled:select-none",
    blue: "text-white bg-g-blue-1 capitalize disabled:cursor-not-allowed disabled:select-none",
    gray: "text-white bg-gray-500 opacity-75 capitalize disabled:cursor-not-allowed disabled:select-none",
    ...
    "outline-gold": "outline outline-1 outline-primary-color text-black",
