  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row sm:justify-start mb-3 space-x-3.5">
        ...
        <Link to="/dashboard/create-blog" className="w-48">
          <Button
        ...
        <table className="table-sorter table-bordered-bottom w-full text-gray-500 dark:text-gray-400 dataTable-table">
          <thead>
            <tr className="!bg-secondary-color dark:bg-gray-900 dark:bg-opacity-40 rounded-2xl">
              ...
              <th className="text-left">Spoiler</th>
              <th>Status</th>
              <th>Action</th>
            </tr>
          </thead>
                ...
                data?.docs?.map((item, id) => {
                  return (
                    <tr key={id}>
                      ...
                      <td className="w-96">
                        <p className="line-clamp-2 w-96">{item.spoiler}</p>
                      </td>
                      <td>
                        <div
                          className={
      ...
      <ModalDelete
        selected={selectedId}
        open={blog.modalDelete}
        setOpen={() => blog.setModalDelete(false)}
      />
    </>
  );
}
